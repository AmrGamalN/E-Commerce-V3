...
class FollowController {
  ...
  async addFollow(req: Request, res: Response): Promise<void> {
    try {
      const addFollow = await this.serviceInstance.addFollow(
        req.user,
        req.body
      );
      if (addFollow) {
      ...
      this.handleError(res, "Failed to add follow!", error);
    }
  }
  ...
  async getFollow(req: Request, res: Response): Promise<void> {
    try {
      ...
      this.handleError(res, "Failed to get follow", error);
    }
  }
  ...
  async getAllFollow(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      this.handleError(res, `Failed to get ${typeFollow}`, error);
    }
  }
  ...
  async deleteFollow(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      this.handleError(res, `Failed to delete ${typeFollow}`, error);
    }
  }
  ...
  async countFollow(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      this.handleError(res, `Failed to fetch count ${typeFollow}!`, error);
    }
  }
  ...
  async searchFollow(req: Request, res: Response): Promise<void> {
    try {
      ...
      this.handleError(res, `Failed to search!`, error);
    }
  }
}
